...
`manualJ8-ts-1.3.0` — 1.1.0 plus ceiling CLTD family rows 16B/16C/16D/16F
(1.2.0/1.2.1) and climate-dependent Construction 19 floor PTD tables (1.3.0),
all transcribed from Table 4A pp. 362-377 of the physical book on 2026-07-15;
...
column of the D1 database. Current version: **`manualJ8-ts-1.3.0`**
