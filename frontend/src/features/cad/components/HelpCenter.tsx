...
const sections: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'Pipe Builder',
        desc: 'Draw refrigerant, condensate, and gas piping. Click to start, click again to place segments. Select a pipe to set material (copper liquid/suction, PVC condensate, gas black iron) and diameter. Lives on the Piping layer.',
      },
      {
        title: 'Draw Duct (X)',
        desc: 'Lay out supply and return duct runs. Runs live on the Ducts (Supply) / Ducts (Return) layers and accept sizes pushed from Manual D via "Apply to CAD".',
      },
      {
        title: 'Place Fitting (J)',
        desc: 'Drop duct fittings — elbows, tees, takeoffs, and boots — along a run for equivalent-length and pressure-drop accounting.',
      },
      {
        title: 'Dimension (D)',
  ...
  },
  {
    ...
    items: [
      {
        title: 'Layer types',
        desc: 'Nine layers control visibility: Walls (green), Openings (blue), HVAC (purple), Piping (pink), Ducts Supply (blue), Ducts Return (red), Radiant Systems (orange), Annotations (amber), and Underlay (gray). Toggle the eye icon to show/hide each layer.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'I', desc: 'Add Window' },
      { title: 'O', desc: 'Add Door' },
      { title: 'U', desc: 'Place HVAC unit' },
      { title: 'X', desc: 'Draw Duct' },
      { title: 'J', desc: 'Place Fitting' },
      { title: 'D', desc: 'Dimension tool' },
      { title: 'L', desc: 'Label tool' },
      { title: 'R', desc: 'Detect Rooms' },
      { title: 'G', desc: 'Toggle grid snap' },
      { title: 'T', desc: 'Toggle toolbox panel' },
      { title: 'P', desc: 'Toggle properties panel' },
      { title: 'F', desc: 'Toggle floors panel' },
      { title: 'N', desc: 'Toggle top nav bar' },
      { title: '`', desc: 'Focus mode (collapse all panels)' },
      { title: 'Ctrl + Z', desc: 'Undo last action' },
      { title: 'Ctrl + Y', desc: 'Redo last action' },
      { title: 'Ctrl + S', desc: 'Save project' },
      { title: 'Ctrl + E', desc: 'Export PDF' },
      { title: 'Delete', desc: 'Remove selected object' },
