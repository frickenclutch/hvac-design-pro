...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    advancedContent: (
      <div className="space-y-3">
        <p>Engine: <code className="text-emerald-400/70">frontend/src/engines/manualJ8/</code>, version stamp <code>manualJ8-ts-1.2.0</code> (1.1.0 + ceiling CLTD family rows transcribed from the physical ACCA book, Table 4A pp. 362-363). Validated against ACCA reference test cases (Smith / Walker / Cobb) at 184/184 line items within 0.5% tolerance, enforced in CI by the vitest cert suite.</p>
